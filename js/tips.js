...
tips = new Array(121);
//条目内容
tips[0] = '青春岂不惜，行乐非所欲。 ——文天祥';
tips[1] = '送人玫瑰，手流余香。——公益广告';
tips[2] = '青年人，小心一点，凡是使你眼睛放光的，就常常能使你中毒，应该明白这点点！ ——沈从文';
tips[3] = '假如青春是一种缺陷的话，那也是我们太快就会失去的缺陷。 ——洛威尔';
tips[4] = '伸出您的友爱之手,让更多的孩子重返校园。——公益广告';
tips[5] = '青年时种下什么，老年时就收获什么。 ——易卜生';
tips[6] = '爱心一片,真情永远。——公益广告';
tips[7] = '聆听心声,实现愿望。——公益广告';
tips[8] = '不要讥笑老年人，因为你也会有老年。 ——米南德';
tips[9] = '你做的事情最好是你晚年时愿意回忆的事。 ——奥理略';
tips[10] = '如果年轻时太放纵的话，将失去心灵的滋润，太节制又将变得死板。——圣佩韦';
...
tips[41] = '年轻的妙处在你的经验不足以让你知道你不能做你现在在做的事。——佚名';
...
tips[89] = '生当作人杰，死亦为鬼雄，至今思项羽，不肯过江东。 —— 李清照 ';
tips[90] = '人类被赋予了一种工作，那就是精神的成长。 —— 列夫·托尔斯泰';
tips[91] = '人在智慧上应当是明豁的，道德上应该是清白的，身体上应该是清洁的。 —— 契诃夫';
tips[92] = '良心是由人的知识和全部生活方式来决定的。 —— 马克思';
tips[93] = '奢则妄取苟取，志气卑辱；一从俭约，则于人无求，于己无愧，是可以养气也。  —— 罗大经';
tips[94] = '如果道德败坏了，趣味也必然会堕落。——狄德罗';
tips[95] = '人只有献身于社会，才能找出那短暂而有风险的生命的意义。 —— 爱因斯坦';
...
tips[100] = '让我们把不名誉作为刑罚最重的部分吧！ —— 孟德斯鸠';
tips[101] = '对于事实问题的健全的判断是一切德行的真正基础。 —— 夸美纽斯';
tips[102] = '德行的实现是由行为，不是由文字。 —— 夸美纽斯';
tips[103] = '对于事实问题的健全的判断是一切德行的真正基础。 —— 夸美纽斯';
tips[104] = '阴谋陷害别人的人，自己会首先遭到不幸。 —— 伊索';
tips[105] = '对于事实问题的健全的判断是一切德行的真正基础。 —— 夸美纽斯 ';
tips[106] = '强本而节用，则天不能贫。 —— 荀况';
tips[107] = '如果道德败坏了，趣味也必然会堕落。——狄德罗 ';
tips[108] = '知耻近乎勇。 —— 孔丘';
tips[109] = '辱，莫大于不知耻。 —— 王通';
tips[110] = '君子忧道不忧贫。 —— 孔丘';
tips[111] = '贫而无谄，富而无骄。 —— 子贡';
tips[112] = '强本而节用，则天不能贫。 —— 荀况';
tips[113] = '侈而惰者贫，而力而俭者富。 —— 韩非';
tips[114] = '夫君子之行，静以修身，俭以养德，非淡泊无以明志，非宁静无以致远。 —— 诸葛亮';
tips[115] = '奢者狼藉俭者安，一凶一吉在眼前。 —— 白居易';
tips[116] = '不念居安思危，戒奢以俭；斯以伐根而求木茂，塞源而欲流长也。 —— 魏徵';
tips[117] = '历览前贤国与家，成由勤俭破由奢。 —— 李商隐';
tips[118] = '霸祖孤身取二江，子孙多以百城降。豪华尽出成功后，逸乐安知与祸双？ —— 王安石';
tips[119] = '侈则多欲。君子多欲则念慕富贵，枉道速祸。 —— 司马光';
tips[120] = '奢则妄取苟取，志气卑辱；一从俭约，则于人无求，于己无愧，是可以养气也。  —— 罗大经';
